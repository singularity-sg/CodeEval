...
public class TestDiscount_offers {
	...
	private discount_offers d = new discount_offers();
...
//        float score = d.calculateScore(res.get("customers"), res.get("products"));
        ...
        assertEquals(21.0f, d.process(test));
    }

    @Test
    public void testNoColision(){
    	Float[][] data = new Float[][]{
    		{6f, 7f, 6f},
    		{4.5f, 6f, 6.75f},
    		{9f, 5f, 6f}
    		};
    	assertEquals(22.75f, d.calculateScore(data));
    }
...
//        float score = d.calculateScore(res.get("customers"), res.get("products"));
        ...
        assertEquals(83.50f, d.process(test));
